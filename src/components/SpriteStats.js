...
const SpriteStats = ({setNoOfSprites, selectedSprite, setSelectedSprite, noOfSprites, currentCommandIndex, handleAnimateAll}) => {
  return (
    <div className="row-span-2 mr-4 mb-4 rounded-md drop-shadow-xl bg-white">
              <div
                onClick={() => setNoOfSprites(2)}
              ...
              <div className="grid grid-cols-5 gap-4 mt-4 ml-4">
                <div
                  ...
                  onClick={() => {setSelectedSprite("sprite1"); currentCommandIndex.current = 0}}
                >
                  <img
                    id="sprite1"
                    src="/catSprite2.png"
                ...
                {noOfSprites == 2 && <div
                  style={{ background: "azure" }}
                  onClick={() => {setSelectedSprite("sprite2"); currentCommandIndex.current = 0}}
                  className={`col-start-2 cursor-pointer h-16 p-2 w-20 drop-shadow-lg rounded-lg ${
